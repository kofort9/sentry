...
class TestPatcherAgentValidation:
    ...
    def test_single_attempt_validation_success(self):
        ...
        self.patcher.validation_tool.validate_operations = Mock(
            return_value={"valid": True, "issues": [], "suggestions": []}
        )
    ...
    def test_multiple_validation_attempts_with_learning(self):
        ...
        self.patcher.llm.generate.side_effect = [invalid_json1, invalid_json2, valid_json]
    ...
    def test_learning_context_extraction(self):
        ...
        validation_attempts = [
            ...
            {"validation": {"valid": False, "issues": ["File path error"]}, "attempt": 2},
            {"validation": {"valid": True, "issues": []}, "attempt": 3},
        ]
    ...
    def test_conversation_history_tracking(self, mock_datetime):
        ...
        # Act
        self.patcher.generate_patch(plan, context)
...
"""
        ...
        responses = [
            ...
            json.dumps(
                {
                    "ops": [
                        {"file": "tests/test_calc.py", "find": "assert result == 6"}
                    ]  # Missing replace
                }
            ),
            # Attempt 3: Success
