...
class BaseTool(ABC):
    ...
    def validate_inputs(self, *args, **kwargs) -> bool:
        ...
        for param in self._metadata.required_params:
            if param not in kwargs:
                raise ValueError(f"Required parameter '{param}' missing for tool '{self._metadata.name}'")
    ...
    def get_usage_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "output_type": self._metadata.output_type.__name__ if self._metadata.output_type else None,
...
class ToolRegistry:
    ...
    def get_registry_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "tools_by_category": {cat.value: len(tools) for cat, tools in 
                                self.get_tools_by_category(cat).items() for cat in ToolCategory},
        }
...
class FunctionTool(BaseTool):
    ...
    def __init__(self, func: Callable, metadata: ToolMetadata = None, config: Dict[str, Any] = None):
        self.func = func
    ...
    def execute(self, input_data: Any) -> Any:
        ...
        for i, tool in enumerate(self.tools):
            try:
                ...
                raise ValueError(f"Error in composed tool step {i} ({tool.get_metadata().name}): {e}")
