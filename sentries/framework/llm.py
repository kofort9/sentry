...
class BaseLLMWrapper(ABC):
    ...
    def generate(self, messages: List[Dict[str, str]], **kwargs) -> str:
        ...
        # All attempts failed
        raise RuntimeError(f"LLM request failed after {self.config.retry_attempts} attempts: {last_exception}")
    
    def generate_structured(self, messages: List[Dict[str, str]], schema: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        """
    ...
    def _record_request(self, messages: List[Dict[str, str]], response: Optional[LLMResponse], 
                       params: Dict[str, Any], success: bool, error: Exception = None):
