...
class BaseAgent(ABC):
    ...
    def _record_execution(self, input_data: Any, output_data: Any, duration: float, success: bool):
        ...
        execution_record = {
            ...
            "output_summary": str(output_data)[:200] + "..." if len(str(output_data)) > 200 else str(output_data),
    ...
    def _add_to_conversation_history(self, role: str, content: str, metadata: Dict[str, Any] = None):
