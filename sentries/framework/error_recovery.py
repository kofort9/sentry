...
class ErrorRecoverySystem:
    ...
    def with_recovery(self, func: Callable, context: Dict[str, Any] = None, 
                     custom_max_retries: int = None) -> Any:
        """
        ...
        # All attempts failed
        if last_error_info:
            raise RuntimeError(f"Operation failed after {max_attempts + 1} attempts. "
